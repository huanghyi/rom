  ...
  (b = (function () {
    ...
    return (a.prototype.extend = function (a, b) {
      ...
      return null == b && (b = !1), null == c && (c = !1), null == d &&
        ...
        ? ((e = document.createEvent ('CustomEvent')), e.initCustomEvent (
            a,
            b,
            c,
            d
    ...
    return (e.prototype.defaults = {
      ...
      if ((null == a && (a = this.element), 1 === a.nodeType)) {
        for (
          ...
          (b = e[c]), g.call (this.all, b) < 0
            ? (this.boxes.push (b), this.all.push (b), this.stopped ||
                this.disabled ()
                ? this.resetStyle ()
      ...
      return this.applyStyle (a), (a.className =
        ...
        this.config.callback (a), this.util ().emitEvent (
        a,
        this.wowEvent
      ), this.util ().addEvent (
        a,
      ...
      return a.type.toLowerCase ().indexOf ('animationend') >= 0
        ? ((b = a.target || a.srcElement), (b.className = b.className
      ...
      var c, e, f, g, h, i;
      for (
        (h = d (a)), (g = h.getPropertyCSSValue (b)), (f = this
          .vendors), (c = 0), (e = f.length);
        e > c;
        c++
      )
      ...
      var b, c, d, e, f;
      return (c =
        a.getAttribute ('data-wow-offset') || this.config.offset), (f =
        window.pageYOffset), (e =
        f +
        Math.min (this.element.clientHeight, this.util ().innerHeight ()) -
        c), (d = this.offsetTop (a)), (b = d + a.clientHeight), e >= d &&
        b >= f;
