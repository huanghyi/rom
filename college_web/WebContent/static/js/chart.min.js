/*
 * @Author: your name
 * @Date: 2020-06-02 13:41:57
 * @LastEditTime: 2020-06-02 13:45:34
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \IT学习\Bootstrap学习\College-manager-demo.2\js\chart.js
 */
...
!(function (t, e) {
  ...
  var e = {
    ...
    n = (function (t, e) {
      ...
      for (var r in a) if (a.hasOwnProperty (r)) {
          ...
          delete a[r].channels, delete a[r].labels, Object.defineProperty (
            a[r],
            'channels',
            {value: o}
      ...
      (a.rgb.hsl = function (t) {
        ...
        return (i /= 100), (r /= 108.883), (n = (n /= 95.047) > 0.008856
          ? Math.pow (n, 1 / 3)
          : 7.787 * n + 16 / 116), [
          116 *
        ...
        for (var u = 0; u < 3; u++)
          (i = o + 1 / 3 * -(u - 1)) < 0 && i++, i > 1 && i--, (r = 6 * i < 1
            ? e + 6 * (n - e) * i
            : 2 * i < 1
                ? n
                : 3 * i < 2 ? e + (n - e) * (2 / 3 - i) * 6 : e), (a[u] =
            255 * r);
        return a;
        ...
        var e,
          ...
          d = t[2] / 100,
          h = u + d;
        switch ((h > 1 && ((u /= h), (d /= h)), (i =
          6 * l - (e = Math.floor (6 * l))), 0 != (1 & e) && (i = 1 - i), (a =
          u + i * ((n = 1 - d) - u)), e)) {
          default:
          case 6:
          case 0:
        ...
        return (n = -0.9689 * a + 1.8758 * r + 0.0415 * o), (i =
          0.0557 * a + -0.204 * r + 1.057 * o), (e = (e =
          3.2406 * a + -1.5372 * r + -0.4986 * o) > 0.0031308
          ? 1.055 * Math.pow (e, 1 / 2.4) - 0.055
          : 12.92 * e), (n = n > 0.0031308
          ? 1.055 * Math.pow (n, 1 / 2.4) - 0.055
          : 12.92 * n), (i = i > 0.0031308
        ...
        var e = t[0], n = t[1], i = t[2];
        return (n /= 100), (i /= 108.883), (e = (e /= 95.047) > 0.008856
          ? Math.pow (e, 1 / 3)
          : 7.787 * e + 16 / 116), [
          116 *
        ...
        return (n = r > 0.008856 ? r : (n - 16 / 116) / 7.787), (e = o >
          0.008856
          ? o
          : (e - 16 / 116) / 7.787), (i = s > 0.008856
          ? s
          : (i - 16 / 116) / 7.787), [
          (e *= 95.047),
          (n *= 100),
        ...
        return (i = n < 0.5 ? 2 * e * n : 2 * e * (1 - n)) < 1 &&
        ...
        var e = t[1] / 100, n = t[2] / 100 * (1 - e) + 0.5 * e, i = 0;
        return n > 0 && n < 0.5
          ? (i = e / (2 * n))
          : n >= 0.5 && n < 1 && (i = e / (2 * (1 - n))), [
          t[0],
  ...
  Object.keys (n).forEach (function (t) {
    (o[
      t
    ] = {}), Object.defineProperty (o[t], 'channels', {value: n[t].channels}), Object.defineProperty (o[t], 'labels', {value: n[t].labels});
    var e = (function (t) {
      for (
      ...
      (o[t][n] = (function (t) {
        ...
        var e = function (e) {
          return null == e
            ? e
            : (arguments.length > 1 &&
                (e = Array.prototype.slice.call (arguments)), t (e));
        };
        return 'conversion' in t && (e.conversion = t.conversion), e;
      }) (i));
    });
  ...
  (y.prototype = {
    ...
    hue: function (t) {
      return t && (t = (t %= 360) < 0 ? 360 + t : t), this.setChannel (
        'hsl',
        0,
        t
      );
  ...
  }), (y.prototype.spaces = {rgb: ['red', 'green', 'blue'], hsl: ['hue', 'saturation', 'lightness'], hsv: ['hue', 'saturation', 'value'], hwb: ['hue', 'whiteness', 'blackness'], cmyk: ['cyan', 'magenta', 'yellow', 'black']}), (y.prototype.maxes = {rgb: [255, 255, 255], hsl: [360, 100, 100], hsv: [360, 100, 100], hwb: [360, 100, 100], cmyk: [100, 100, 100, 100]}), (y.prototype.getValues = function (
    t
  ) {
    ...
    if (
      ...
      return !1;
    for (n = 0; n < t.length; n++)
      (i = Math.max (0, Math.min (o[t][n], a[t][n]))), (a[t][n] = Math.round (
        i
      ));
    for (var d in r)
      d !== t && (a[d] = s[t][d] (a[t]));
    ...
    return void 0 === n
      ? this.getValues (t)
      : ('number' == typeof n &&
          (n = Array.prototype.slice.call (e)), this.setValues (t, n), this);
  ...
  var _,
    ...
    w = {
      ...
      inherits: function (t) {
        ...
        return (i.prototype =
          e.prototype), (n.prototype = new i ()), (n.extend = w.inherits), t &&
          w.extend (n.prototype, t), (n.__super__ = e.prototype), n;
      },
    ...
    easeInOutElastic: function (t) {
      ...
      return 0 === t
        ...
        : 2 == (t /= 0.5)
            ...
            : (n || (n = 0.45), i < 1
                ? ((i = 1), (e = n / 4))
                : (e = n / (2 * Math.PI) * Math.asin (1 / i)), t < 1
                ? i *
                    Math.pow (2, 10 * (t -= 1)) *
                    Math.sin ((t - e) * (2 * Math.PI) / n) *
                    -0.5
    ...
    L = {
      ...
      roundedRect: function (t, e, n, i, a, r) {
        if (r) {
          var o = Math.min (r, a / 2, i / 2),
            ...
            u = e + i - o,
            d = n + a - o;
          t.moveTo (e, l), s < u && l < d
            ? (t.arc (s, l, o, -P, -T), t.arc (u, l, o, -T, 0), t.arc (
                u,
                d,
                o,
                0,
            ...
            : s < u
                ? (t.moveTo (s, n), t.arc (u, l, o, -T, T), t.arc (
                    s,
                    l,
                    o,
                    T,
                ...
                : l < d
                    ...
                    : t.arc (s, l, o, -P, P), t.closePath (), t.moveTo (e, n);
        } else t.rect (e, n, i, a);
      },
      drawPoint: function (t, e, n, i, a, r) {
        ...
        if (
          ...
          return t.save (), t.translate (i, a), t.rotate (h), t.drawImage (
            e,
            -e.width / 2,
            -e.height / 2,
            e.width,
        ...
        if (!(isNaN (n) || n <= 0)) {
          switch ((t.beginPath (), e)) {
            ...
            case 'triangle':
              ...
              break;
            case 'rectRounded':
              (u = n - (d = 0.516 * n)), (s = Math.cos (h + I) * u), (l =
                Math.sin (h + I) * u), t.arc (
                i - s,
                a - l,
                d,
                h - P,
                h - T
              ), t.arc (i + l, a - s, d, h - T, h), t.arc (
                i + s,
                a + l,
                d,
                h,
                h + T
              ), t.arc (i - l, a + s, d, h + T, h + P), t.closePath ();
              break;
            case 'rect':
              if (!r) {
              ...
              h += I;
            case 'rectRot':
              (s = Math.cos (h) * n), (l = Math.sin (h) * n), t.moveTo (
                i - s,
                a - l
              ), t.lineTo (i + l, a - s), t.lineTo (i + s, a + l), t.lineTo (
                i - l,
                a + s
              ), t.closePath ();
              break;
            ...
            case 'cross':
              (s = Math.cos (h) * n), (l = Math.sin (h) * n), t.moveTo (
                i - s,
                a - l
              ), t.lineTo (i + s, a + l), t.moveTo (i + l, a - s), t.lineTo (
                i - l,
                a + s
              );
              break;
            case 'star':
              (s = Math.cos (h) * n), (l = Math.sin (h) * n), t.moveTo (
                ...
                i - l,
                a + s
              ), (h += I), (s = Math.cos (h) * n), (l =
                Math.sin (h) * n), t.moveTo (i - s, a - l), t.lineTo (
                i + s,
                a + l
  ...
  var B = {
    ...
    toPadding: function (t) {
      var e, n, i, a;
      return M.isObject (t)
        ? ((e = +t.top || 0), (n = +t.right || 0), (i = +t.bottom || 0), (a =
            +t.left || 0))
        : (e = n = i = a = +t || 0), {
        top: e,
        right: n,
  ...
  var V = M,
    ...
    Y = {
      ...
      restoreTextDirection: function (t) {
        ...
        void 0 !== e &&
          (delete t.prevTextDirection, t.canvas.style.setProperty (
            'direction',
            e[0],
            e[1]
          ));
  ...
  V.extend (G.prototype, {
    ...
    transition: function (t) {
      ...
      return n && 1 !== t
        ? (a || (a = e._view = {}), i || (i = e._start = {}), (function (
            t,
            e,
            n,
            i
            ...
            for ((a = 0), (r = f.length); a < r; ++a)
              if (
                ((u = n[(o = f[a])]), e.hasOwnProperty (o) || (e[o] = u), (s =
                  e[o]) !== u && '_' !== o[0])
              ) {
                if (
                  (t.hasOwnProperty (o) || (t[o] = s), (d = typeof u) ===
                    typeof (l = t[o]))
                )
                  if ('string' === d) {
  ...
  var $ = {
    ...
    addAnimation: function (t, e, n, i) {
      ...
      for (
        (e.chart = t), (e.startTime = Date.now ()), (e.duration = n), i ||
          (t.animating = !0), (a = 0), (r = o.length);
        a < r;
        ++a
      )
    ...
    startDigest: function () {
      this.advance (), this.animations.length > 0 &&
        this.requestAnimationFrame ();
    },
    advance: function () {
      for (var t, e, n, i, a = this.animations, r = 0; r < a.length; )
        (e = (t = a[r]).chart), (n = t.numSteps), (i =
          Math.floor ((Date.now () - t.startTime) / t.duration * n) +
          1), (t.currentStep = Math.min (i, n)), V.callback (
          t.render,
          [e, t],
          e
        ), V.callback (t.onAnimationProgress, [t], e), t.currentStep >= n
          ? (V.callback (
  ...
  V.extend (et.prototype, {
    ...
    linkScales: function () {
      ...
      (null !== t.xAxisID && t.xAxisID in n && !i.xAxisID) ||
        (t.xAxisID = i.xAxisID || a.xAxes[0].id), (null !== t.yAxisID &&
        t.yAxisID in n &&
        !i.yAxisID) ||
    ...
    getStyle: function (t) {
      ...
      return this._configure (), i && void 0 === t
        ? (e = this._resolveDatasetElementOptions (i || {}))
        : ((t = t || 0), (e = this._resolveDataElementOptions (
            n.data[t] || {},
            t
          ))), (!1 !== e.fill && null !== e.fill) ||
        (e.backgroundColor = e.borderColor), e;
    },
    ...
    _setDatasetHoverStyle: function () {
      ...
      if (o) {
        for (
          (r = o._model), (a = this._resolveDatasetElementOptions (
            o,
            !0
    ...
    onDataSplice: function (t, e) {
      this.getMeta ().data.splice (t, e), this.insertElements (
        t,
        arguments.length - 2
      );
    },
  ...
  function rt (t, e, n) {
    ...
    i
      ...
      : ((t.lineWidth = e.borderWidth), (t.lineJoin =
          'bevel')), n.fullCircles &&
      (function (t, e, n, i) {
        var a, r = n.endAngle;
        for (
          i &&
            ((n.endAngle = n.startAngle + it), at (
              t,
              n
            ), (n.endAngle = r), n.endAngle === n.startAngle &&
              n.fullCircles &&
              ((n.endAngle += it), n.fullCircles--)), t.beginPath (), t.arc (
            n.x,
            n.y,
            n.innerRadius,
            n.startAngle + it,
        ...
        n,
        i
      ), i && at (t, n), t.beginPath (), t.arc (n.x, n.y, e.outerRadius, n.startAngle, n.endAngle), t.arc (n.x, n.y, n.innerRadius, n.endAngle, n.startAngle, !0), t.closePath (), t.stroke ();
  }
  z._set ('global', {
    elements: {
      arc: {
  ...
  var ot = X.extend ({
    ...
    draw: function () {
      ...
      if (
        (e.save (), (e.fillStyle = n.backgroundColor), (e.strokeStyle =
          n.borderColor), a.fullCircles)
      ) {
        for (
          (a.endAngle = a.startAngle + it), e.beginPath (), e.arc (
            a.x,
            a.y,
            a.outerRadius,
            a.startAngle,
      ...
      e.beginPath (), e.arc (
        ...
        a.startAngle,
        !0
      ), e.closePath (), e.fill (), n.borderWidth && rt (e, n, a), e.restore ();
    },
  }),
    st = V.valueOrDefault,
  ...
  var ut = X.extend ({
    ...
    draw: function () {
      ...
      if (s.length) {
        ...
        for (
          r.save (), (r.lineCap =
            a.borderCapStyle || u.borderCapStyle), r.setLineDash &&
            r.setLineDash (
              a.borderDash || u.borderDash
            ), (r.lineDashOffset = st (
            a.borderDashOffset,
            u.borderDashOffset
          )), (r.lineJoin =
            a.borderJoinStyle || u.borderJoinStyle), (r.lineWidth = st (
            a.borderWidth,
            u.borderWidth
          )), (r.strokeStyle =
            a.borderColor || l.defaultColor), r.beginPath (), (n = s[0]._view)
            .skip || (r.moveTo (n.x, n.y), (d = 0)), (t = 1);
          t < s.length;
          ++t
        )
          (n = s[t]._view), (e = -1 === d
            ...
            ((d !== t - 1 && !o) || -1 === d
              ? r.moveTo (n.x, n.y)
              : V.canvas.lineTo (r, e._view, n), (d = t));
    ...
    draw: function (t) {
      ...
      e.skip ||
        ((void 0 === t || V.canvas._isPointInArea (e, t)) &&
          ((n.strokeStyle = e.borderColor || u), (n.lineWidth = dt (
            e.borderWidth,
            l.elements.point.borderWidth
          )), (n.fillStyle = e.backgroundColor || u), V.canvas.drawPoint (
            n,
            i,
            r,
            o,
  ...
  function mt (t) {
    var e, n, i, a, r;
    return pt (t)
      ? ((r = t.width / 2), (e = t.x - r), (n = t.x + r), (i = Math.min (
          t.y,
          t.base
        )), (a = Math.max (t.y, t.base)))
      : ((r = t.height / 2), (e = Math.min (t.x, t.base)), (n = Math.max (
          t.x,
          t.base
        )), (i = t.y - r), (a =
          t.y + r)), {left: e, top: i, right: n, bottom: a};
  }
  function vt (t, e, n) {
      ...
      l = (function (t) {
        ...
        return e
          ? (t.horizontal
              ...
              : t.base < t.y && (e = vt (e, 'bottom', 'top')), (n[e] = !0), n)
          : n;
      }) (t);
    return V.isObject (s)
      ? ((i = +s.top || 0), (a = +s.right || 0), (r = +s.bottom || 0), (o =
          +s.left || 0))
      : (i = a = r = o =
          +s ||
          0), {t: l.top || i < 0 ? 0 : i > n ? n : i, r: l.right || a < 0 ? 0 : a > e ? e : a, b: l.bottom || r < 0 ? 0 : r > n ? n : r, l: l.left || o < 0 ? 0 : o > e ? e : o};
  }
  function xt (t, e, n) {
  ...
  var yt = X.extend ({
    ...
    draw: function () {
      var t = this._chart.ctx,
        ...
        i = n.outer,
        a = n.inner;
      (t.fillStyle = e.backgroundColor), t.fillRect (
        i.x,
        i.y,
        i.w,
        i.h
        ...
        (t.save (), t.beginPath (), t.rect (
          ...
          i.w,
          i.h
        ), t.clip (), (t.fillStyle = e.borderColor), t.rect (
          a.x,
          a.y,
          a.w,
          a.h
      ...
      l = V.isNullOrUndef (r)
        ? (function (t, e) {
            ...
            for ((a = 0), (r = t.getTicks ().length); a < r; ++a)
              (i = t.getPixelForTick (a)), (o = a > 0
                ? Math.min (o, Math.abs (i - n))
                : o), (n = i);
            return o;
          }) (e.scale, e.pixels)
        : -1;
    return V.isNullOrUndef (r)
  ...
  var Dt = nt.extend ({
    ...
    initialize: function () {
      var t, e, n = this;
      nt.prototype.initialize.apply (
        n,
        arguments
      ), ((t = n.getMeta ()).stack = n.getDataset ().stack), (t.bar = !0), (e = n._getIndexScale ()
        .options), Ct (
        'bar chart',
        e.barPercentage,
    ...
    updateElement: function (t, e, n) {
      ...
      (t._xScale = i.getScaleForId (a.xAxisID)), (t._yScale = i.getScaleForId (
        a.yAxisID
        ...
        (t._model.borderSkipped = null), i._updateElementGeometry (
        t,
        e,
        n,
        o
    ...
    _updateElementGeometry: function (t, e, n, i) {
      ...
      (r.horizontal = l), (r.base = n ? s : d.base), (r.x = l
        ? n ? s : d.head
        : h.center), (r.y = l ? h.center : n ? s : d.head), (r.height = l
        ? h.size
        : void 0), (r.width = l ? void 0 : h.size);
    },
    ...
    calculateBarValuePixels: function (t, e, n) {
      var i,
        ...
        y = void 0 === p.start
          ? p.end
          : p.max >= 0 && p.min >= 0 ? p.max - p.min : p.min - p.max,
        _ = g.length;
        ...
        for (i = 0; i < _ && (a = g[i]).index !== t; ++i)
          a.stack === b &&
            ((r = void 0 === (u = h._parseValue (f[a.index].data[e])).start
              ? u.end
              : u.min >= 0 && u.max >= 0 ? u.max : u.min), ((p.min < 0 &&
              r < 0) ||
              (p.max >= 0 && r > 0)) &&
              (x += r));
      return (o = h.getPixelForValue (x)), (l =
        (s = h.getPixelForValue (x + y)) - o), void 0 !== m &&
        Math.abs (l) < m &&
    ...
    calculateBarIndexPixels: function (t, e, n, i) {
      var a = 'flex' === i.barThickness
        ? (function (t, e, n) {
            ...
            return null === o &&
              (o = r - (null === s ? e.end - e.start : s - r)), null === s &&
              (s = r + r - o), (i = r - (r - Math.min (o, s)) / 2 * l), {
    ...
    _resolveDataElementOptions: function () {
      ...
      return (e.barPercentage = Pt (
        ...
        n.maxBarThickness,
        e.maxBarThickness
      )), (e.minBarLength = Pt (i.minBarLength, e.minBarLength)), e;
    },
  }),
    Tt = V.valueOrDefault,
  ...
  var Ft = nt.extend ({
    ...
    setHoverStyle: function (t) {
      ...
      (t.$previousStyle = {
        ...
        n.hoverBorderColor,
        i (n.borderColor)
      )), (e.borderWidth = Tt (n.hoverBorderWidth, n.borderWidth)), (e.radius =
        n.radius + n.hoverRadius);
    },
    _resolveDataElementOptions: function (t, e) {
      var n = this,
        i = n.chart,
      ...
      return n._cachedDataOpts === s && (s = V.extend ({}, s)), (s.radius = It (
      ...
      if ((a.setAttribute ('class', t.id + '-legend'), o.length))
        for ((e = 0), (n = o[0].data.length); e < n; ++e)
          ((i = a.appendChild (document.createElement ('li'))).appendChild (
            ...
            o[0].backgroundColor[e]), s[e] &&
            i.appendChild (document.createTextNode (s[e]));
      return a.outerHTML;
    },
    legend: {
      labels: {
  ...
  var Nt = nt.extend ({
    ...
    update: function (t) {
      ...
      if (m < Rt) {
        ...
        (u = (D - P) / 2), (d = (T - A) / 2), (h = -(D + P) / 2), (c =
          -(T + A) / 2);
      }
      for ((i = 0), (a = g.length); i < a; ++i)
        g[i]._options = r._resolveDataElementOptions (g[i], i);
      for (
        (o.borderWidth = r.getMaxBorderWidth ()), (e =
          (s.right - s.left - o.borderWidth) / u), (n =
          (s.bottom - s.top - o.borderWidth) / d), (o.outerRadius = Math.max (
          Math.min (e, n) / 2,
          0
        )), (o.innerRadius = Math.max (o.outerRadius * p, 0)), (o.radiusLength =
          (o.outerRadius - o.innerRadius) /
          (r._getVisibleDatasetWeightTotal () || 1)), (o.offsetX =
          h * o.outerRadius), (o.offsetY =
          c * o.outerRadius), (f.total = r.calculateTotal ()), (r.outerRadius =
          o.outerRadius -
          o.radiusLength *
            r._getRingWeightOffset (r.index)), (r.innerRadius = Math.max (
    ...
    updateElement: function (t, e, n) {
      ...
      (n && s.animateRotate) ||
        ((v.startAngle = 0 === e
          ? o.rotation
          : i.getMeta ().data[e - 1]._model.endAngle), (v.endAngle =
          v.startAngle + v.circumference)), t.pivot ();
    },
    ...
    getMaxBorderWidth: function (t) {
      ...
      if (!t)
        for ((e = 0), (n = d.data.datasets.length); e < n; ++e)
          if (d.isDatasetVisible (e)) {
            (t = (i = d.getDatasetMeta (e)).data), e !== this.index &&
              (r = i.controller);
            break;
          }
      if (!t) return 0;
      for ((e = 0), (n = t.length); e < n; ++e)
        (a = t[e]), r
          ...
          : (o = a._options), 'inner' !== o.borderAlign &&
          ((s = o.borderWidth), (u = (l = o.hoverBorderWidth) >
            (u = s > u ? s : u)
            ? l
            : u));
      return u;
  ...
  var Ut = nt.extend ({
    ...
    update: function (t) {
      ...
      for (
        (i._xScale = i.getScaleForId (
          a.xAxisID
        )), (i._yScale = i.getScaleForId (a.yAxisID)), u &&
          (void 0 !== l.tension &&
            void 0 === l.lineTension &&
            (l.lineTension = l.tension), (r._scale =
            i._yScale), (r._datasetIndex =
            i.index), (r._children = o), (r._model = i._resolveDatasetElementOptions (
            r
    ...
    updateElement: function (t, e, n) {
      ...
      (i = h.getPixelForValue ('object' == typeof d ? d : NaN, e, u)), (a = n
        ? c.getBasePixel ()
        : r.calculatePointY (
            d,
            e,
            u
          )), (t._xScale = h), (t._yScale = c), (t._options = g), (t._datasetIndex = u), (t._index = e), (t._model = {
        x: i,
        y: a,
    ...
    _resolveDatasetElementOptions: function (t) {
      ...
      return (o.spanGaps = Et (n.spanGaps, a.spanGaps)), (o.tension = Et (
        n.lineTension,
        r.tension
      )), (o.steppedLine = Wt ([
        i.steppedLine,
    ...
    calculatePointY: function (t, e, n) {
      ...
      if (h.options.stacked) {
        for (
          ...
          (a = d.data.datasets[r.index]), 'line' === r.type &&
            r.yAxisID === h.id &&
    ...
    updateBezierControlPoints: function () {
      ...
      if (
        ...
        for ((t = 0), (e = l.length); t < e; ++t)
          (n = l[t]._model), (i = V.splineCurve (
            V.previousItem (l, t)._model,
            n,
            V.nextItem (l, t)._model,
            o.tension
          )), (n.controlPointPreviousX =
            i.previous.x), (n.controlPointPreviousY =
            i.previous.y), (n.controlPointNextX =
    ...
    draw: function () {
      ...
      for (
        this._showLine &&
        ((t = n.dataset._model.clip), V.canvas.clipArea (e.ctx, {
        ...
        }), n.dataset.draw (), V.canvas.unclipArea (e.ctx));
        o < s;
        ++o
      )
        i[o].draw (a);
  ...
  var Gt = nt.extend ({
    ...
    update: function (t) {
      var e,
        ...
        d = o.data;
      for (
        a._updateRadius (), (o.count = a.countVisibleElements ()), (e = 0), (n =
          r.data.length);
        e < n;
        e++
      )
      ...
      for ((e = 0), (n = d.length); e < n; ++e)
        (d[e]._options = a._resolveDataElementOptions (
          d[e],
          e
    ...
    _updateRadius: function () {
      ...
      (e.outerRadius = Math.max (a / 2, 0)), (e.innerRadius = Math.max (
        i.cutoutPercentage ? e.outerRadius / 100 * i.cutoutPercentage : 1,
        0
      )), (e.radiusLength =
        (e.outerRadius - e.innerRadius) /
        e.getVisibleDatasetCount ()), (t.outerRadius =
        e.outerRadius - e.radiusLength * t.index), (t.innerRadius =
  ...
  var Zt = nt.extend ({
    ...
    update: function (t) {
      ...
      for (
        void 0 !== l.tension &&
          void 0 === l.lineTension &&
          (l.lineTension = l.tension), (r._scale = s), (r._datasetIndex =
          i.index), (r._children = o), (r._loop = !0), (r._model = i._resolveDatasetElementOptions (
          r
        )), r.pivot (), (e = 0), (n = o.length);
        e < n;
        ++e
    ...
    _resolveDatasetElementOptions: function () {
      ...
      return (i.spanGaps = Kt (e.spanGaps, n.spanGaps)), (i.tension = Kt (
        e.lineTension,
        n.elements.line.tension
      )), i;
    },
    updateBezierControlPoints: function () {
      var t,
  ...
  var ae = {
    modes: {
      ...
      dataset: function (t, e, n) {
        ...
        return r.length > 0 &&
          (r = t.getDatasetMeta (r[0]._datasetIndex).data), r;
      },
      'x-axis': function (t, e) {
  ...
  function ue (t, e, n) {
    ...
    if (
      (n.size && (t[n.pos] -= n.size), (n.size = n.horizontal
        ? r.height
        : r.width), (t[n.pos] += n.size), r.getPadding)
    ) {
      var s = r.getPadding ();
      (o.top = Math.max (o.top, s.top)), (o.left = Math.max (
        o.left,
        s.left
      )), (o.bottom = Math.max (o.bottom, s.bottom)), (o.right = Math.max (
        o.right,
        s.right
      ));
    }
    if (
      ((i = e.outerWidth - le (o, t, 'left', 'right')), (a =
        e.outerHeight - le (o, t, 'top', 'bottom')), i !== t.w || a !== t.h)
    )
  ...
  var fe,
    ge = {
      defaults: {},
      addBox: function (t, e) {
        t.boxes || (t.boxes = []), (e.fullWidth =
          e.fullWidth || !1), (e.position = e.position || 'top'), (e.weight =
          e.weight || 0), (e._layers =
          e._layers ||
          function () {
            return [
              {
      ...
      update: function (t, e, n) {
        if (t) {
          ...
          !(function (t, e) {
            ...
            for ((n = 0), (i = t.length); n < i; ++n)
              ((a = t[n]).width = a.horizontal
                ...
                : e.vBoxMaxWidth), (a.height = a.horizontal && e.hBoxMaxHeight);
          }) (l.concat (u), d), he (l, h, d), he (u, h, d) &&
            he (l, h, d), (function (t) {
            var e = t.maxPadding;
            function n (n) {
          ...
          }) (h), ce (s.leftAndTop, h, d), (h.x += h.w), (h.y += h.h), ce (
            s.rightAndBottom,
            h,
            d
          ), (t.chartArea = {
  ...
  function Ae (t, e, n) {
    var i,
      ...
      l = (s.resizer = (function (t) {
        ...
        n.appendChild (Pe ()), i.appendChild (Pe ()), e.appendChild (
          n
        ...
        return Me (n, 'scroll', a.bind (n, 'expand')), Me (
          i,
          'scroll',
          a.bind (i, 'shrink')
        ), e;
        ...
        ((i = function () {
          ...
          (o = Array.prototype.slice.call (arguments)), (a = a || this), r ||
            ((r = !0), V.requestAnimFrame.call (window, function () {
              (r = !1), i.apply (a, o);
            }));
        })
      ));
      ...
      if (!this.disableCSSInjection) {
        ...
        !(function (t, e) {
          ...
          if (!n.containsStyles) {
            ...
            i.setAttribute ('type', 'text/css'), i.appendChild (
  ...
  var Ie = Te._enabled
    ...
    : {
        acquireContext: function (t) {
          return t && t.canvas && (t = t.canvas), (t && t.getContext ('2d')) ||
            null;
        },
      },
    Fe = V.extend (
    ...
    descriptors: function (t) {
      ...
      return this._plugins.concat (a.plugins || []).forEach (function (t) {
        if (-1 === n.indexOf (t)) {
          var e = t.id, a = r[e];
          !1 !== a &&
            (!0 === a && (a = V.clone (z.global.plugins[e])), n.push (
              t
    ...
    Oe = {
      ...
      addScalesToLayout: function (t) {
        V.each (t.scales, function (e) {
          (e.fullWidth =
            e.options.fullWidth), (e.position = e.options.position), (e.weight = e.options.weight), ge.addBox (t, e);
        });
      },
    },
    Re = V.valueOrDefault,
  ...
  z._set ('global', {
    tooltips: {
      ...
      callbacks: {
        ...
        label: function (t, e) {
          var n = e.datasets[t.datasetIndex].label || '';
          return n && (n += ': '), V.isNullOrUndef (t.value)
            ? (n += t.yLabel)
            : (n += t.value), n;
        },
  ...
  function Be (t, e) {
    return e &&
      (V.isArray (e) ? Array.prototype.push.apply (t, e) : t.push (e)), t;
  }
  function Ee (t) {
  ...
  var je = X.extend ({
    ...
    getBody: function (t, e) {
      ...
      return V.each (t, function (t) {
        ...
        Be (
          r.before,
          Ee (i.beforeLabel.call (n, t, e))
        ), Be (r.lines, i.label.call (n, t, e)), Be (r.after, Ee (i.afterLabel.call (n, t, e))), a.push (r);
      }), a;
    },
    ...
    update: function (t) {
      ...
      if (p.length) {
        ...
        for ((e = 0), (n = p.length); e < n; ++e)
          w.push (
            ((i =
              p[
                e
              ]), (a = void 0), (r = void 0), (o = void 0), (s = void 0), (l = void 0), (u = void 0), (d = void 0), (a =
              i._xScale), (r = i._yScale || i._scale), (o = i._index), (s =
              i._datasetIndex), (l = i._chart.getDatasetMeta (s)
              .controller), (u = l._getIndexScale ()), (d = l._getValueScale ()), {
        ...
        c.filter &&
        ...
        }), (g.title = h.getTitle (w, m)), (g.beforeBody = h.getBeforeBody (
          w,
          m
        )), (g.body = h.getBody (w, m)), (g.afterBody = h.getAfterBody (
          w,
          m
        )), (g.footer = h.getFooter (w, m)), (g.x = y.x), (g.y =
          y.y), (g.caretPadding =
          c.caretPadding), (g.labelColors = _), (g.labelTextColors = k), (g.dataPoints = w), (x = (function (
          t,
          e
        ) {
          var n = t._chart.ctx,
          ...
          var s = e.title.length,
            ...
            d = e.bodyFontSize,
            h = e.footerFontSize;
          (i += s * u), (i += s ? (s - 1) * e.titleSpacing : 0), (i += s
            ? e.titleMarginBottom
            : 0), (i += o * d), (i += o ? (o - 1) * e.bodySpacing : 0), (i += l
            ? e.footerMarginTop
            : 0), (i += l * h), (i += l ? (l - 1) * e.footerSpacing : 0);
          var c = 0,
            f = function (t) {
              a = Math.max (a, n.measureText (t).width + c);
            };
          return (n.font = V.fontString (
            u,
            e._titleFontStyle,
            e._titleFontFamily
          )), V.each (e.title, f), (n.font = V.fontString (
            d,
            e._bodyFontStyle,
            e._bodyFontFamily
          )), V.each (
          ...
          return 'right' === u
            ...
            : 'center' === u &&
                ((a -= e.width / 2) + e.width > i.width &&
                  (a = i.width - e.width), a < 0 && (a = 0)), 'top' === d
            ? (r += h)
            : (r -= 'bottom' === d ? e.height + h : e.height / 2), 'center' ===
            d
            ? 'left' === u ? (a += h) : 'right' === u && (a -= h)
            : 'left' === u ? (a -= c) : 'right' === u && (a += c), {x: a, y: r};
        }) (
          g,
          x,
          (v = (function (t, e) {
      ...
      return (g.xAlign = v.xAlign), (g.yAlign = v.yAlign), (g.x = b.x), (g.y =
        b.y), (g.width = x.width), (g.height = x.height), (g.caretX =
        y.x), (g.caretY = y.y), (h._model = g), t &&
        c.custom &&
        c.custom.call (h, g), h;
    },
    ...
    drawTitle: function (t, e, n) {
      ...
      if (s) {
        ...
        for (
          (t.x = Ve (e, e._titleAlign)), (n.textAlign = l.textAlign (
            e._titleAlign
          )), (n.textBaseline = 'middle'), (i = e.titleFontSize), (a =
            e.titleSpacing), (n.fillStyle =
            e.titleFontColor), (n.font = V.fontString (
            i,
            e._titleFontStyle,
            e._titleFontFamily
          )), (r = 0);
          ...
          n.fillText (o[r], l.x (t.x), t.y + i / 2), (t.y += i + a), r + 1 ===
            s && (t.y += e.titleMarginBottom - a);
      }
    },
    drawBody: function (t, e, n) {
      var i,
        ...
        y = b.textAlign (f);
      for (
        (n.textAlign = f), (n.textBaseline = 'middle'), (n.font = V.fontString (
          h,
          e._bodyFontStyle,
          e._bodyFontFamily
        )), (t.x = Ve (e, y)), (n.fillStyle = e.bodyFontColor), V.each (
          e.beforeBody,
          x
        ), (m = p && 'right' !== y
          ? 'center' === f ? h / 2 + 1 : h + 2
        ...
        for (
          (i = g[s]), (a = e.labelTextColors[s]), (r =
            e.labelColors[s]), (n.fillStyle = a), V.each (
            i.before,
            x
          ), (l = 0), (d = (o = i.lines).length);
          l < d;
          ++l
        ) {
          if (p) {
            var _ = b.x (v);
            (n.fillStyle = e.legendColorBackground), n.fillRect (
              b.leftForLtr (_, h),
              t.y,
              h,
              h
            ), (n.lineWidth = 1), (n.strokeStyle =
              r.borderColor), n.strokeRect (
              b.leftForLtr (_, h),
              t.y,
              h,
              h
            ), (n.fillStyle = r.backgroundColor), n.fillRect (
    ...
    drawFooter: function (t, e, n) {
      ...
      if (o) {
        ...
        for (
          (t.x = Ve (e, e._footerAlign)), (t.y +=
            e.footerMarginTop), (n.textAlign = s.textAlign (
            e._footerAlign
          )), (n.textBaseline = 'middle'), (i =
            e.footerFontSize), (n.fillStyle =
            e.footerFontColor), (n.font = V.fontString (
            i,
            e._footerFontStyle,
            e._footerFontFamily
          )), (a = 0);
          ...
          n.fillText (r[a], s.x (t.x), t.y + i / 2), (t.y +=
            i + e.footerSpacing);
      }
    },
    drawBackground: function (t, e, n, i) {
      (n.fillStyle = e.backgroundColor), (n.strokeStyle =
        e.borderColor), (n.lineWidth = e.borderWidth);
      var a = e.xAlign,
        r = e.yAlign,
        o = t.x,
        s = t.y,
        ...
        u = i.height,
        d = e.cornerRadius;
      n.beginPath (), n.moveTo (o + d, s), 'top' === r &&
        this.drawCaret (t, i), n.lineTo (o + l - d, s), n.quadraticCurveTo (
        o + l,
        s,
        o + l,
        s + d
      ), 'center' === r && 'right' === a && this.drawCaret (t, i), n.lineTo (
        o + l,
        s + u - d
      ), n.quadraticCurveTo (o + l, s + u, o + l - d, s + u), 'bottom' === r &&
        this.drawCaret (t, i), n.lineTo (o + d, s + u), n.quadraticCurveTo (
        o,
        s + u,
        o,
        s + u - d
      ), 'center' === r && 'left' === a && this.drawCaret (t, i), n.lineTo (
        o,
        s + d
      ), n.quadraticCurveTo (
        o,
    ...
    draw: function () {
      ...
      if (0 !== e.opacity) {
        ...
        this._options.enabled &&
          r &&
          (t.save (), (t.globalAlpha = a), this.drawBackground (
            i,
            e,
            t,
            n
          ), (i.y += e.yPadding), V.rtl.overrideTextDirection (
            t,
            e.textDirection
          ), this.drawTitle (i, e, t), this.drawBody (
            i,
            e,
            t
          ), this.drawFooter (i, e, t), V.rtl.restoreTextDirection (
            t,
            e.textDirection
          ), t.restore ());
      }
    ...
    handleEvent: function (t) {
      ...
      return (n._lastActive = n._lastActive || []), 'mouseout' === t.type
        ? (n._active = [])
        : ((n._active = n._chart.getElementsAtEventForMode (
            t,
            i.mode,
            i
          )), i.reverse && n._active.reverse ()), (e = !V.arrayEquals (
        n._active,
        n._lastActive
      )) &&
        ((n._lastActive = n._active), (i.enabled || i.custom) &&
          ((n._eventPosition = {x: t.x, y: t.y}), n.update (
            !0
          ), n.pivot ())), e;
    },
  }),
      ...
      merger: function (t, e, n, i) {
        if ('xAxes' === t || 'yAxes' === t) {
          ...
          for (e[t] || (e[t] = []), (a = 0); a < s; ++a)
            ...
            )), a >= e[t].length && e[t].push ({}), !e[t][a].type ||
              (o.type && o.type !== e[t][a].type)
  ...
  function Ke (t) {
    ...
    V.each (t.scales, function (e) {
      ...
      z[t.config.type],
      e
    )), (t.options = t.config.options = e), t.ensureScalesHaveIDs (), t.buildOrUpdateScales (), (t.tooltip._options = e.tooltips), t.tooltip.initialize ();
  }
  function Ze (t, e, n) {
    var i,
      a = function (t) {
  ...
  V.extend (Qe.prototype, {
    construct: function (t, e) {
      ...
      e = (function (t) {
        ...
        return (e.datasets = e.datasets || []), (e.labels = e.labels || []), (t.options = Xe (
          z.global,
          z[t.type],
          t.options || {}
        )), t;
      ...
      var i = Fe.acquireContext (t, e),
        ...
        r = a && a.height,
        o = a && a.width;
      (n.id = V.uid ()), (n.ctx = i), (n.canvas = a), (n.config = e), (n.width = o), (n.height = r), (n.aspectRatio = r
        ? o / r
        : null), (n.options =
        e.options), (n._bufferedRender = !1), (n._layers = []), (n.chart = n), (n.controller = n), (Qe.instances[
        n.id
      ] = n), Object.defineProperty (n, 'data', {
        get: function () {
    ...
    initialize: function () {
      var t = this;
      return Le.notify (t, 'beforeInit'), V.retinaScale (
        t,
        t.options.devicePixelRatio
      ), t.bindEvents (), t.options.responsive &&
        t.resize (!0), t.initToolTip (), Le.notify (t, 'afterInit'), t;
    },
    clear: function () {
    ...
    resize: function (t) {
      ...
      if (
        ...
        ((i.width = e.width = r), (i.height = e.height = o), (i.style.width =
          r + 'px'), (i.style.height = o + 'px'), V.retinaScale (
          e,
          n.devicePixelRatio
        ), !t)
      ) {
        var s = {width: r, height: o};
        Le.notify (e, 'resize', [s]), n.onResize &&
          n.onResize (e, s), e.stop (), e.update ({
    ...
    buildOrUpdateScales: function () {
      ...
      e.scales &&
        ...
        if (r in n && n[r].type === o)
          ...
          if (!l) return;
          (s = new l ({id: r, type: o, options: i, ctx: t.ctx, chart: t})), (n[
            s.id
          ] = s);
        }
    ...
    buildOrUpdateControllers: function () {
      ...
      for ((t = 0), (e = a.length); t < e; t++) {
        ...
        if (
          (o.type &&
            o.type !== s &&
            (n.destroyDatasetMeta (t), (o = n.getDatasetMeta (
              t
            ))), (o.type = s), (o.order =
            r.order || 0), (o.index = t), o.controller)
        )
    ...
    update: function (t) {
      ...
      if (
        ((t && 'object' == typeof t) ||
          (t = {duration: t, lazy: arguments[1]}), Ke (i), Le._invalidate (
          i
        ...
        i.updateLayout (), i.options.animation &&
          i.options.animation.duration &&
          V.each (a, function (t) {
            t.reset ();
          }), i.updateDatasets (), i.tooltip.initialize (), (i.lastActive = []), Le.notify (
          i,
          'afterUpdate'
        ), i._layers.sort (Je ('z', '_idx')), i._bufferedRender
          ? (i._bufferedRequest = {
              duration: t.duration,
              easing: t.easing,
              lazy: t.lazy,
    ...
    updateLayout: function () {
      ...
      !1 !== Le.notify (t, 'beforeLayout') &&
        (ge.update (this, this.width, this.height), (t._layers = []), V.each (
          t.boxes,
          function (e) {
            e._configure && e._configure (), t._layers.push.apply (
              t._layers,
              e._layers ()
            );
          },
    ...
    draw: function (t) {
      var e, n, i = this;
      if (
        (i.clear (), V.isNullOrUndef (t) && (t = 1), i.transition (
          t
    ...
    destroy: function () {
      ...
      i &&
        (n.unbindEvents (), V.canvas.clear (n), Fe.releaseContext (
          n.ctx
        ), (n.canvas = null), (n.ctx = null)), Le.notify (
        n,
        'destroy'
    ...
    unbindEvents: function () {
      ...
      e &&
        (delete t._listeners, V.each (e, function (e, n) {
    ...
    eventHandler: function (t) {
      ...
      if (!1 !== Le.notify (e, 'beforeEvent', [t])) {
        ...
        n &&
          (i = n._start
            ? n.handleEvent (t)
            : i | n.handleEvent (t)), Le.notify (e, 'afterEvent', [t]);
    ...
    handleEvent: function (t) {
      ...
      return (n.lastActive = n.lastActive || []), 'mouseout' === t.type
        ? (n.active = [])
        : (n.active = n.getElementsAtEventForMode (t, a.mode, a)), V.callback (
        i.onHover || i.hover.onHover,
        [t.native, n.active],
        n
      ), ('mouseup' !== t.type && 'click' !== t.type) ||
        (i.onClick && i.onClick.call (n, t.native, n.active)), n.lastActive
        .length && n.updateHoverStyle (n.lastActive, a.mode, !1), n.active
        .length &&
        a.mode &&
        n.updateHoverStyle (n.active, a.mode, !0), (e = !V.arrayEquals (
        n.active,
        n.lastActive
      ...
      !(n &&
        ((i = 1 === a
          ...
          : 0 === e
              ...
              : (o - t.getPixelForTick (r - 1)) / 2), (o += r < e ? i : -i) <
          s - 1e-6 || o > l + 1e-6))
    )
      return o;
  }
  function hn (t, e, n, i) {
    ...
    for (a = 0; a < v; ++a) {
      if (
        ((s = n[a].label), (l = n[a].major ? e.major : e.minor), (t.font = u =
          l.string), (d = i[u] = i[u] || {data: {}, gc: []}), (h =
          l.lineHeight), (c = f = 0), sn (s) || on (s))
      ) {
        if (on (s))
    ...
    return (function (t, e) {
      ...
      i,
      v
    ), (p = b.indexOf (Math.max.apply (null, b))), (m = x.indexOf (Math.max.apply (null, x))), {first: _ (0), last: _ (v - 1), widest: _ (p), highest: _ (m)};
  }
  function cn (t) {
  ...
  function fn (t) {
    var e, n;
    return t.display
      ? ((e = V.options._parseFont (t)), (n = V.options.toPadding (
          t.padding
  ...
  var bn = X.extend ({
    ...
    update: function (t, e, n) {
      ...
      if (
        (l.beforeUpdate (), (l.maxWidth = t), (l.maxHeight = e), (l.margins = V.extend (
          {left: 0, right: 0, top: 0, bottom: 0},
          n
        )), (l._ticks = null), (l.ticks = null), (l._labelSizes = null), (l._maxLabelLines = 0), (l.longestLabelWidth = 0), (l.longestTextCache = l.longestTextCache || {}), (l._gridLineItems = null), (l._labelItems = null), l.beforeSetDimensions (), l.setDimensions (), l.afterSetDimensions (), l.beforeDataLimits (), l.determineDataLimits (), l.afterDataLimits (), l.beforeBuildTicks (), (o = l.buildTicks () || []), (!(o =
          l.afterBuildTicks (o) || o) ||
          !o.length) &&
          l.ticks)
      )
        for ((o = []), (i = 0), (a = l.ticks.length); i < a; ++i)
          o.push ({value: l.ticks[i], major: !1});
      return (l._ticks = o), (s = d < o.length), (r = l._convertTicksToLabels (
        s
          ? (function (t, e) {
              for (
          ...
          : o
      )), l._configure (), l.beforeCalculateTickRotation (), l.calculateTickRotation (), l.afterCalculateTickRotation (), l.beforeFit (), l.fit (), l.afterFit (), (l._ticksToDraw = u.display &&
        (u.autoSkip || 'auto' === u.source)
        ? l._autoSkip (o)
        : o), s &&
        (r = l._convertTicksToLabels (
          l._ticksToDraw
        )), (l.ticks = r), l.afterUpdate (), l.minSize;
    },
    _configure: function () {
      ...
      n.isHorizontal ()
        ? ((t = n.left), (e = n.right))
        : ((t = n.top), (e =
            n.bottom), (i = !i)), (n._startPixel = t), (n._endPixel = e), (n._reversePixels = i), (n._length =
        e - t);
    },
    ...
    setDimensions: function () {
      ...
      t.isHorizontal ()
        ...
        : ((t.height = t.maxHeight), (t.top = 0), (t.bottom =
            t.height)), (t.paddingLeft = 0), (t.paddingTop = 0), (t.paddingRight = 0), (t.paddingBottom = 0);
    },
    ...
    calculateTickRotation: function () {
      ...
      !s._isVisible () || !u.display || h >= c || d <= 1 || !s.isHorizontal ()
        ? (s.labelRotation = h)
        : ((e = (t = s._getLabelSizes ()).widest.width), (n =
            t.highest.height - t.highest.offset), (i = Math.min (
            s.maxWidth,
            s.chart.width - e
          )), e + 6 > (a = l.offset ? s.maxWidth / d : i / (d - 1)) &&
            ((a = i / (d - (l.offset ? 0.5 : 1))), (r =
              s.maxHeight -
              cn (l.gridLines) -
              u.padding -
              fn (l.scaleLabel)), (o = Math.sqrt (
              e * e + n * n
            )), (f = V.toDegrees (
              Math.min (
            ...
            )), (f = Math.max (h, Math.min (c, f)))), (s.labelRotation = f));
    },
    ...
    fit: function () {
      var t = this,
        ...
        u = t.isHorizontal ();
      if (
        (u ? (e.width = t.maxWidth) : s && (e.width = cn (o) + fn (r)), u
          ? s && (e.height = cn (o) + fn (r))
          : (e.height = t.maxHeight), a.display && s)
      ) {
        var d = pn (a),
          h = t._getLabelSizes (),
          c = h.first,
        ...
        if (u) {
          ...
          b
            ? ((w = l
                ...
                : _ * (c.height - c.offset)), (M = l
                ? _ * (f.height - f.offset)
                : y * f.width + _ * f.offset))
            : ((w = c.width / 2), (M = f.width / 2)), (t.paddingLeft =
            Math.max ((w - S) * t.width / (t.width - S), 0) +
            3), (t.paddingRight =
            Math.max ((M - C) * t.width / (t.width - C), 0) + 3);
        } else {
          var P = a.mirror ? 0 : g.width + v + m;
          (e.width = Math.min (t.maxWidth, e.width + P)), (t.paddingTop =
            c.height / 2), (t.paddingBottom = f.height / 2);
        }
      }
      t.handleMargins (), u
        ? ((t.width = t._length =
            n.width - t.margins.left - t.margins.right), (t.height = e.height))
        : ((t.width = e.width), (t.height = t._length =
            n.height - t.margins.top - t.margins.bottom));
    },
    handleMargins: function () {
      var t = this;
      t.margins &&
        ((t.margins.left = Math.max (
          t.paddingLeft,
          t.margins.left
        )), (t.margins.top = Math.max (
          t.paddingTop,
          t.margins.top
        )), (t.margins.right = Math.max (
          t.paddingRight,
          t.margins.right
    ...
    _convertTicksToLabels: function (t) {
      ...
      for (
        (a.ticks = t.map (function (t) {
          return t.value;
        })), a.beforeTickToLabelConversion (), (e =
          a.convertTicksToLabels (t) ||
          a.ticks), a.afterTickToLabelConversion (), (n = 0), (i = t.length);
        n < i;
        ++n
      )
        t[n].label = e[n];
    ...
    _getLabelSizes: function () {
      ...
      return e ||
        ((t._labelSizes = e = hn (
          ...
          t.getTicks (),
          t.longestTextCache
        )), (t.longestLabelWidth = e.widest.width)), e;
    },
    _parseValue: function (t) {
      var e, n, i, a;
      return on (t)
        ? ((e = +this.getRightValue (t[0])), (n = +this.getRightValue (
            t[1]
          )), (i = Math.min (e, n)), (a = Math.max (e, n)))
    ...
    getPixelForDecimal: function (t) {
      return this._reversePixels && (t = 1 - t), this._startPixel +
        t * this._length;
    },
    ...
    _autoSkip: function (t) {
      ...
      if (
        ...
        for ((e = 0), (n = u - 1); e < n; e++)
          vn (t, i, l[e], l[e + 1]);
        return (a = u > 1 ? (h - d) / (u - 1) : null), vn (
          t,
          i,
          V.isNullOrUndef (a) ? 0 : d - a,
          d
        ), vn (t, i, h, V.isNullOrUndef (a) ? t.length : h + a), mn (t);
      }
      return vn (t, i), mn (t);
    },
    _tickSize: function () {
    ...
    _computeGridLineItems: function (t) {
      ...
      for (
        'top' === k
          ? ((e = F (b.bottom)), (s = b.bottom - P), (u = e - T), (h =
              F (t.top) + T), (f = t.bottom))
          : 'bottom' === k
              ? ((e = F (b.top)), (h = t.top), (f = F (t.bottom) - T), (s =
                  e + T), (u = b.top + P))
              : 'left' === k
                  ? ((e = F (b.right)), (o = b.right - P), (l = e - T), (d =
                      F (t.left) + T), (c = t.right))
                  : ((e = F (b.left)), (d = t.left), (c = F (t.right) - T), (o =
                      e + T), (l = b.left + P)), (n = 0);
        n < C;
        ++n
      )
        (i = S[n] || {}), (sn (i.label) && n < S.length) ||
          (n === b.zeroLineIndex && y.offset === w
            ? ((g = _.zeroLineWidth), (p =
                _.zeroLineColor), (m = _.zeroLineBorderDash || []), (v =
                _.zeroLineBorderDashOffset || 0))
            : ((g = un (_.lineWidth, n, 1)), (p = un (
                _.color,
                n,
                'rgba(0,0,0,0.1)'
              )), (m = _.borderDash || []), (v =
                _.borderDashOffset || 0)), void 0 !==
            (a = dn (b, i._index || n, w)) &&
            ((r = I (x, a, g)), M
              ? (o = l = d = c = r)
              : (s = u = h = f = r), A.push ({
      ...
      for (
        'top' === p
          ...
          : 'bottom' === p
              ...
              : 'left' === p
                  ? ((a = c.right - (m ? 0 : _) - y), (o = m
                      ? 'left'
                      : 'right'))
                  : ((a = c.left + (m ? 0 : _) + y), (o = m
                      ? 'right'
                      : 'left')), (t = 0), (e = b.length);
        t < e;
        ++t
        ...
        (i = (n = b[t]).label), sn (i) ||
          ((s =
            c.getPixelForTick (n._index || t) +
            g.labelOffset), (u = (l = n.major ? x.major : x.minor)
            .lineHeight), (d = on (i) ? i.length : 1), v
            ? ((a = s), (h = 'top' === p
                ? ((k ? 1 : 0.5) - d) * u
                : (k ? 0 : 0.5) * u))
    ...
    _drawGrid: function (t) {
      ...
      if (n.display) {
        ...
        for ((r = 0), (o = c.length); r < o; ++r)
          (i = (s = c[r]).width), (a = s.color), i &&
            a &&
            (l.save (), (l.lineWidth = i), (l.strokeStyle = a), l.setLineDash &&
              (l.setLineDash (s.borderDash), (l.lineDashOffset =
                s.borderDashOffset)), l.beginPath (), n.drawTicks &&
              (l.moveTo (s.tx1, s.ty1), l.lineTo (
                s.tx2,
                s.ty2
              )), n.drawOnChartArea &&
              (l.moveTo (s.x1, s.y1), l.lineTo (
                s.x2,
                s.y2
              )), l.stroke (), l.restore ());
        if (h) {
          var f,
            ...
            x = c.borderValue;
          e.isHorizontal ()
            ? ((f = d (u, e.left, v) - v / 2), (g =
                d (u, e.right, b) + b / 2), (p = m = x))
            : ((p = d (u, e.top, v) - v / 2), (m =
                d (u, e.bottom, b) +
                b / 2), (f = g = x)), (l.lineWidth = h), (l.strokeStyle = un (
            n.color,
            0
    ...
    _drawLabels: function () {
      ...
      if (t.options.ticks.display) {
        ...
        for ((e = 0), (i = d.length); e < i; ++e) {
          if (
            ((o = (r = d[e]).font), u.save (), u.translate (
              r.x,
              r.y
            ), u.rotate (r.rotation), (u.font = o.string), (u.fillStyle =
              o.color), (u.textBaseline = 'middle'), (u.textAlign =
              r.textAlign), (s = r.label), (l = r.textOffset), on (s))
          )
    ...
    _drawTitle: function () {
      ...
      if (i.display) {
        ...
        e.save (), e.translate (a, r), e.rotate (h), (e.textAlign =
          'center'), (e.textBaseline = 'middle'), (e.fillStyle = o), (e.font =
          s.string), e.fillText (i.labelString, 0, 0), e.restore ();
      }
    },
    draw: function (t) {
      this._isVisible () &&
        ...
        ? [
            {
              z: i,
              draw: function () {
                t._drawGrid.apply (t, arguments), t._drawTitle.apply (
                  t,
                  arguments
                );
              },
    ...
    _n = xn.extend ({
      determineDataLimits: function () {
        var t,
          ...
          o = 0,
          s = n.length - 1;
        void 0 !== a && (t = n.indexOf (a)) >= 0 && (o = t), void 0 !== r &&
          (t = n.indexOf (r)) >= 0 &&
          (s = t), (e.minIndex = o), (e.maxIndex = s), (e.min = n[o]), (e.max =
          n[s]);
      },
      buildTicks: function () {
      ...
      _configure: function () {
        ...
        xn.prototype._configure.call (t), t.isHorizontal () ||
          (t._reversePixels = !t._reversePixels), n &&
          ((t._startValue =
            t.minIndex - (e ? 0.5 : 0)), (t._valueRange = Math.max (
            n.length - (e ? 0 : 1),
            1
          )));
      },
      getPixelForValue: function (t, e, n) {
        var i, a, r, o = this;
        return yn (e) || yn (n) || (t = o.chart.data.datasets[n].data[e]), yn (
          t
        ) || (i = o.isHorizontal () ? t.x : t.y), (void 0 !== i ||
          (void 0 !== t && isNaN (e))) &&
          ((a = o._getLabels ()), (t = V.valueOrDefault (i, t)), (e = -1 !==
            (r = a.indexOf (t))
            ? r
            : e), isNaN (e) && (e = t)), o.getPixelForDecimal (
  ...
  var Sn = xn.extend ({
      ...
      void 0 !== e.min
        ...
        : void 0 !== e.suggestedMin &&
            (null === t.min
              ...
              : (t.min = Math.min (t.min, e.suggestedMin))), void 0 !== e.max
        ? (t.max = e.max)
        : void 0 !== e.suggestedMax &&
            (null === t.max
              ? (t.max = e.suggestedMax)
              : (t.max = Math.max (t.max, e.suggestedMax))), a !== r &&
        t.min >= t.max &&
        (a ? (t.max = t.min + 1) : (t.min = t.max - 1)), t.min === t.max &&
    ...
    getTickLimit: function () {
      ...
      return n
        ...
        : ((t = this._computeTickLimit ()), (i = i || 11)), i &&
        (t = Math.min (i, t)), t;
    },
      ...
      var t = this,
        ...
        a = (t.ticks = (function (t, e) {
          ...
          (r = Math.ceil (g / p) - Math.floor (f / p)) > u &&
            (p = V.niceNum (r * p / u / l) * l), s || Mn (c)
            ? (n = Math.pow (10, V._decimalPlaces (p)))
            : ((n = Math.pow (10, c)), (p = Math.ceil (p * n) / n)), (i =
            Math.floor (f / p) * p), (a = Math.ceil (g / p) * p), s &&
            (!Mn (d) && V.almostWhole (d / p, p / 1e3) && (i = d), !Mn (h) &&
              V.almostWhole (h / p, p / 1e3) &&
              (a = h)), (r = (a - i) / p), (r = V.almostEquals (
            r,
            Math.round (r),
            p / 1e3
          )
            ? Math.round (r)
            : Math.ceil (r)), (i = Math.round (i * n) / n), (a =
            Math.round (a * n) / n), o.push (Mn (d) ? i : d);
          for (var m = 1; m < r; ++m)
            o.push (Math.round ((i + m * p) * n) / n);
          return o.push (Mn (h) ? a : h), o;
        }) (i, t));
      t.handleDirectionalChanges (), (t.max = V.max (a)), (t.min = V.min (
        a
      )), e.reverse
    ...
    convertTicksToLabels: function () {
      var t = this;
      (t.ticksAsNumbers = t.ticks.slice ()), (t.zeroLineIndex = t.ticks.indexOf (
        0
      )), xn.prototype.convertTicksToLabels.call (t);
    },
    _configure: function () {
      var t, e = this, n = e.getTicks (), i = e.min, a = e.max;
      xn.prototype._configure.call (e), e.options.offset &&
        n.length &&
        ((i -= t =
          (a - i) /
          Math.max (n.length - 1, 1) /
          2), (a += t)), (e._startValue = i), (e._endValue = a), (e._valueRange =
        a - i);
    },
  }),
  ...
  var Dn = Sn.extend ({
    determineDataLimits: function () {
      var t,
        ...
        d = s.length;
      if (
        ((a.min = Number.POSITIVE_INFINITY), (a.max =
          Number.NEGATIVE_INFINITY), void 0 === l)
      )
        for (t = 0; !l && t < d; ++t)
      ...
      V.each (u, function (t) {
        (i = t.pos.concat (
          t.neg
        )), (a.min = Math.min (a.min, V.min (i))), (a.max = Math.max (a.max, V.max (i)));
      }), (a.min = V.isFinite (a.min) && !isNaN (a.min)
        ? a.min
        : 0), (a.max = V.isFinite (a.max) && !isNaN (a.max)
        ? a.max
        : 1), a.handleTickRangeOptions ();
    },
    _computeTickLimit: function () {
      var t;
      return this.isHorizontal ()
        ? Math.ceil (this.width / 40)
        : ((t = V.options._parseFont (this.options.ticks)), Math.ceil (
            this.height / t.lineHeight
          ));
    },
  ...
  var Rn = xn.extend ({
    determineDataLimits: function () {
      ...
      (o.min = Number.POSITIVE_INFINITY), (o.max =
        Number.NEGATIVE_INFINITY), (o.minNotZero = Number.POSITIVE_INFINITY);
      var c = s.stacked;
      if (void 0 === c)
        for (t = 0; t < u.length; t++)
          if (
            ((e = l.getDatasetMeta (t)), l.isDatasetVisible (t) &&
              h (e) &&
              void 0 !== e.stack)
          ) {
            c = !0;
      ...
      if (s.stacked || c) {
        ...
        for (t = 0; t < u.length; t++) {
          ...
          if (l.isDatasetVisible (t) && h (e))
            for (
              void 0 === f[g] && (f[g] = []), (a = 0), (r = (i = u[t].data)
                .length);
              a < r;
              a++
            ) {
              var p = f[g];
              (n = o._parseValue (i[a])), isNaN (n.min) ||
                isNaN (n.max) ||
                e.data[a].hidden ||
                n.min < 0 ||
                n.max < 0 ||
          ...
          if (((e = l.getDatasetMeta (t)), l.isDatasetVisible (t) && h (e)))
            for ((a = 0), (r = (i = u[t].data).length); a < r; a++)
              (n = o._parseValue (i[a])), isNaN (n.min) ||
                ...
                n.min < 0 ||
                n.max < 0 ||
                ((o.min = Math.min (n.min, o.min)), (o.max = Math.max (
                  n.max,
                  o.max
                )), 0 !== n.min &&
                  (o.minNotZero = Math.min (n.min, o.minNotZero)));
      (o.min = V.isFinite (o.min) ? o.min : null), (o.max = V.isFinite (o.max)
        ? o.max
        : null), (o.minNotZero = V.isFinite (o.minNotZero)
        ? o.minNotZero
        : null), this.handleTickRangeOptions ();
    },
    handleTickRangeOptions: function () {
      var t = this, e = t.options.ticks;
      (t.min = On (e.min, t.min)), (t.max = On (e.max, t.max)), t.min ===
        t.max &&
        (0 !== t.min && null !== t.min
          ? ((t.min = Math.pow (
              10,
          ...
          : ((t.min = 1), (t.max = 10))), null === t.min &&
        (t.min = Math.pow (10, Math.floor (Fn (t.max)) - 1)), null === t.max &&
        (t.max = 0 !== t.min
          ? Math.pow (10, Math.floor (Fn (t.min)) + 1)
          : 10), null === t.minNotZero &&
        (t.min > 0
          ? (t.minNotZero = t.min)
          : t.max < 1
    ...
    buildTicks: function () {
      var t = this,
        ...
        a = (t.ticks = (function (t, e) {
          ...
          0 === r
            ? ((n = Math.floor (Fn (e.minNotZero))), (i = Math.floor (
                e.minNotZero / Math.pow (10, n)
              )), a.push (r), (r = i * Math.pow (10, n)))
            : ((n = Math.floor (Fn (r))), (i = Math.floor (
                r / Math.pow (10, n)
              )));
          var l = n < 0 ? Math.pow (10, Math.abs (n)) : 1;
          do {
            a.push (r), 10 === ++i && ((i = 1), (l = ++n >= 0 ? 1 : l)), (r =
              Math.round (i * Math.pow (10, n) * l) / l);
          } while (n < o || (n === o && i < s));
          var u = In (t.max, r);
          return a.push (u), a;
        }) (i, t));
      (t.max = V.max (a)), (t.min = V.min (a)), e.reverse
        ? ((n = !n), (t.start = t.max), (t.end = t.min))
        : ((t.start = t.min), (t.end = t.max)), n && a.reverse ();
    },
    convertTicksToLabels: function () {
      (this.tickValues = this.ticks.slice ()), xn.prototype.convertTicksToLabels.call (
        this
      );
    },
    getLabelForIndex: function (t, e) {
    ...
    _configure: function () {
      ...
      xn.prototype._configure.call (t), 0 === e &&
        ((e = t._getFirstTickValue (t.minNotZero)), (n =
          In (t.options.ticks.fontSize, z.global.defaultFontSize) /
          t._length)), (t._startValue = Fn (
        e
      )), (t._valueOffset = n), (t._valueRange =
        (Fn (t.max) - Fn (e)) / (1 - n));
    },
    getPixelForValue: function (t) {
      var e = this, n = 0;
      return (t = +e.getRightValue (t)) > e.min &&
        t > 0 &&
        (n =
          (Fn (t) - e._startValue) / e._valueRange +
          e._valueOffset), e.getPixelForDecimal (n);
    },
    getValueForPixel: function (t) {
  ...
  var Gn = Sn.extend ({
    setDimensions: function () {
      var t = this;
      (t.width = t.maxWidth), (t.height = t.maxHeight), (t.paddingTop =
        Vn (t.options) / 2), (t.xCenter = Math.floor (
        t.width / 2
    ...
    determineDataLimits: function () {
      ...
      }), (t.min = n === Number.POSITIVE_INFINITY ? 0 : n), (t.max = i ===
        Number.NEGATIVE_INFINITY
        ? 0
        : i), t.handleTickRangeOptions ();
    },
    _computeTickLimit: function () {
    ...
    convertTicksToLabels: function () {
      var t = this;
      Sn.prototype.convertTicksToLabels.call (
        t
    ...
    fit: function () {
      ...
      t.display && t.pointLabels.display
        ? (function (t) {
            ...
            for (e = 0; e < d; e++) {
              (i = t.getPointPosition (e, t.drawingArea + 5)), (s = t.ctx), (l =
                a.lineHeight), (u = t.pointLabels[e]), (n = V.isArray (u)
                ? {w: V.longestText (s, s.font, u), h: u.length * l}
                : {w: s.measureText (u).width, h: l}), (t._pointLabelSizes[
                e
              ] = n);
              ...
              f.start < r.l && ((r.l = f.start), (o.l = h)), f.end > r.r &&
                ((r.r = f.end), (o.r = h)), g.start < r.t &&
                ((r.t = g.start), (o.t = h)), g.end > r.b &&
                ((r.b = g.end), (o.b = h));
            }
    ...
    setCenterPoint: function (t, e, n, i) {
      ...
      (a.xCenter = Math.floor ((o + r) / 2 + a.left)), (a.yCenter = Math.floor (
    ...
    _drawGrid: function () {
      ...
      if (
        (r.pointLabels.display &&
          (function (t) {
            ...
            for (var s = t.chart.data.labels.length - 1; s >= 0; s--) {
              ...
              (e.textAlign = jn (c)), Un (c, t._pointLabelSizes[s], u), qn (
                e,
                t.pointLabels[s],
                u,
                o.lineHeight
          ...
          V.each (i.ticks, function (t, n) {
            0 !== n &&
              ((e = i.getDistanceFromCenterForValue (
                ...
                if ((o || s) && l && u) {
                  if (
                    (r.save (), (r.strokeStyle = l), (r.lineWidth = u), r.setLineDash &&
                      (r.setLineDash (e.borderDash || []), (r.lineDashOffset =
                        e.borderDashOffset || 0)), r.beginPath (), o)
                  )
        ...
        for (
          a.save (), (a.lineWidth = l), (a.strokeStyle = u), a.setLineDash &&
            (a.setLineDash (
          ...
          )), (n = i.getPointPosition (t, e)), a.beginPath (), a.moveTo (
            i.xCenter,
            i.yCenter
    ...
    _drawLabels: function () {
      ...
      if (n.display) {
        ...
        e.save (), (e.font = o.string), e.translate (
          t.xCenter,
          t.yCenter
        ), e.rotate (r), (e.textAlign = 'center'), (e.textBaseline =
          'middle'), V.each (t.ticks, function (r, l) {
          (0 !== l || n.reverse) &&
            ((i = t.getDistanceFromCenterForValue (
              t.ticksAsNumbers[l]
            )), n.showLabelBackdrop &&
              ((a = e.measureText (r).width), (e.fillStyle =
                n.backdropColor), e.fillRect (
  ...
  function oi (t, e) {
    ...
    return 'function' == typeof a &&
      (o = a (
        o
      )), V.isFinite (o) || (o = 'string' == typeof r ? n.parse (o, r) : n.parse (o)), null !== o ? +o : (a || 'function' != typeof r || ((o = r (e)), V.isFinite (o) || (o = n.parse (o))), o);
  }
  function si (t, e) {
  ...
  var di = xn.extend ({
    ...
    update: function () {
      ...
      return Kn ('time scale', n.format, 'time.format', 'time.parser'), Kn (
        'time scale',
        n.min,
        'time.min',
        'ticks.min'
      ), Kn ('time scale', n.max, 'time.max', 'ticks.max'), V.mergeIf (
        n.displayFormats,
        i.formats ()
      ), xn.prototype.update.apply (t, arguments);
    },
    getRightValue: function (t) {
      return t && void 0 !== t.t && (t = t.t), xn.prototype.getRightValue.call (
        this,
        t
      );
    },
    determineDataLimits: function () {
      ...
      m.length &&
        ...
        ((g = n > 1
          ...
          : g.sort (ni)), (c = Math.min (c, g[0])), (f = Math.max (
          f,
          g[g.length - 1]
        ))), (c = si (s, ii (d)) || c), (f = si (s, ai (d)) || f), (c = c === Qn
        ? +u.startOf (Date.now (), h)
        : c), (f = f === Jn
        ? +u.endOf (Date.now (), h) + 1
        : f), (s.min = Math.min (c, f)), (s.max = Math.max (
        c + 1,
        f
      )), (s._table = []), (s._timestamps = {data: g, datasets: p, labels: m});
    },
    buildTicks: function () {
      var t,
        e,
          ...
          : 'labels' === c
              ...
              : (function (t, e, n, i) {
                  var a,
                    ...
                    c = [];
                  if (
                    (d && (h = +r.startOf (h, 'isoWeek', d)), (h = +r.startOf (
                      h,
                      d ? 'day' : l
                    )), r.diff (n, e, l) > 1e5 * u)
                  )
                ...
                }) (i, a, r, h)), 'ticks' === o.bounds &&
          u.length &&
          ((a = u[0]), (r = u[u.length - 1])), (a = si (i, ii (o)) || a), (r =
          si (i, ai (o)) || r), (t = 0), (e = u.length);
        t < e;
        ++t
      )
        (n = u[t]) >= a && n <= r && d.push (n);
      return (i.min = a), (i.max = r), (i._unit =
        l.unit ||
        (s.autoSkip
          ...
          : (function (t, e, n, i, a) {
            ...
            }) (i, d.length, l.minUnit, i.min, i.max))), (i._majorUnit = s.major
        .enabled && 'year' !== i._unit
        ? (function (t) {
            for (var e = ei.indexOf (t) + 1, n = ei.length; e < n; ++e)
              if (ti[ei[e]].common) return ei[e];
          }) (i._unit)
        : void 0), (i._table = (function (t, e, n, i) {
        ...
        for (d.push (n), (a = 0), (r = d.length); a < r; ++a)
          (l = d[a + 1]), (o = d[a - 1]), (s = d[a]), (void 0 !== o &&
            void 0 !== l &&
            Math.round ((l + o) / 2) === s) ||
            u.push ({time: s, pos: a / (r - 1)});
        return u;
      }) (i._timestamps.data, a, r, f)), (i._offsets = (function (
        t,
        e,
        n,
        i,
        ...
        return a.offset &&
          e.length &&
          ((r = ri (t, 'time', e[0], 'pos')), (s = 1 === e.length
            ? 1 - r
            : (ri (t, 'time', e[1], 'pos') - r) / 2), (o = ri (
            t,
            'time',
            e[e.length - 1],
            'pos'
      ...
      }) (i._table, d, 0, 0, o)), s.reverse && d.reverse (), ui (
        i,
        d,
        i._majorUnit
      );
    ...
    getLabelForIndex: function (t, e) {
      ...
      return V.isObject (s) && (o = n.getRightValue (s)), r.tooltipFormat
    ...
    getPixelForValue: function (t, e, n) {
      ...
      if (
        (void 0 !== e &&
          void 0 !== n &&
          (i = this._timestamps.datasets[n][e]), null === i &&
          (i = si (this, t)), null !== i)
      )
      ...
      ? {
          ...
          parse: function (e, n) {
            return 'string' == typeof e && 'string' == typeof n
              ? (e = t (e, n))
              : e instanceof t || (e = t (e)), e.isValid ()
              ? e.valueOf ()
              : null;
          },
          format: function (e, n) {
  ...
  function mi (t) {
    return (t.el._scale || {}).getPointPositionForValue
      ? (function (t) {
          ...
          if (!l) return null;
          for (
            (e = s.ticks.reverse ? o.max : o.min), (n = s.ticks.reverse
              ? o.min
              : o.max), (i = o.getPointPositionForValue (0, e)), (a = 0);
            a < l;
            ++a
          )
            (r = 'start' === u || 'end' === u
              ? o.getPointPositionForValue (a, 'start' === u ? e : n)
              : o.getBasePosition (a)), s.gridLines.circular &&
              ((r.cx = i.x), (r.cy = i.y), (r.angle =
                o.getIndexAngle (a) - Math.PI / 2)), d.push (r);
          return d;
        }) (t)
      : (function (t) {
          var e,
          ...
          if (
            ('start' === a
              ...
              : 'end' === a
                  ...
                  : void 0 !== n.scaleZero
                      ? (r = n.scaleZero)
                      : i.getBasePixel && (r = i.getBasePixel ()), null != r)
          ) {
  ...
  var ki = {
    ...
    afterDatasetsUpdate: function (t, e) {
      var n,
        ...
        l = [];
      for (i = 0; i < o; ++i)
        (r = null), (a = (n = t.getDatasetMeta (i)).dataset) &&
          a._model &&
    ...
    beforeDatasetsDraw: function (t) {
      ...
      for (n = l.length - 1; n >= 0; --n)
        (e = l[n].$filler) &&
          e.visible &&
          ((a = (i = e.el)._view), (r = i._children || []), (o = e.mapper), (s =
            a.backgroundColor || z.global.defaultColor), o &&
            s &&
            r.length &&
            (V.canvas.clipArea (u, t.chartArea), _i (
              u,
              r,
              o,
              a,
  ...
  var Pi = X.extend ({
    initialize: function (t) {
      V.extend (
        this,
        t
      ), (this.legendHitBoxes = []), (this._hoveredItem = null), (this.doughnutMode = !1);
    },
    beforeUpdate: Mi,
    update: function (t, e, n) {
      var i = this;
    ...
    setDimensions: function () {
      ...
      t.isHorizontal ()
        ? ((t.width = t.maxWidth), (t.left = 0), (t.right = t.width))
        : ((t.height = t.maxHeight), (t.top = 0), (t.bottom =
            t.height)), (t.paddingLeft = 0), (t.paddingTop = 0), (t.paddingRight = 0), (t.paddingBottom = 0), (t.minSize = {
        width: 0,
        height: 0,
      });
    },
    ...
    fit: function () {
      ...
      if (
        (u
          ...
          : ((l.width = i ? 10 : 0), (l.height = t.maxHeight)), i)
      ) {
        if (((a.font = r.string), u)) {
          var d = (t.lineWidths = [0]), h = 0;
          (a.textAlign = 'left'), (a.textBaseline =
            'middle'), V.each (t.legendItems, function (t, e) {
            var i = Ci (n, o) + o / 2 + a.measureText (t.text).width;
            (0 === e || d[d.length - 1] + i + 2 * n.padding > l.width) &&
              ((h += o + n.padding), (d[
                d.length - (e > 0 ? 0 : 1)
              ] = 0)), (s[e] = {left: 0, top: 0, width: i, height: o}), (d[d.length - 1] += i + n.padding);
          }), (l.height += h);
        } else {
          var c = n.padding,
            f = (t.columnWidths = []),
          ...
          V.each (t.legendItems, function (t, e) {
            ...
            e > 0 &&
              v + o + 2 * c > l.height &&
              ((p += m + n.padding), f.push (m), g.push (
                v
              ), (m = 0), (v = 0)), (m = Math.max (m, i)), (v += o + c), (s[e] = {left: 0, top: 0, width: i, height: o});
    ...
    draw: function () {
      ...
      if (e.display) {
        var d,
          ...
          p = g.size;
        (c.textAlign = h.textAlign ('left')), (c.textBaseline =
          'middle'), (c.lineWidth = 0.5), (c.strokeStyle = f), (c.fillStyle = f), (c.font =
          g.string);
        var m = Ci (n, p),
          v = t.legendHitBoxes,
          b = function (t, i) {
        ...
        V.each (t.legendItems, function (e, i) {
          ...
          !(function (t, e, i) {
            if (!(isNaN (m) || m <= 0)) {
              ...
              if (
                ((c.fillStyle = Si (i.fillStyle, a)), (c.lineCap = Si (
                  i.lineCap,
                  r.borderCapStyle
                )), (c.lineDashOffset = Si (
                  i.lineDashOffset,
                  ...
                  i.lineJoin,
                  r.borderJoinStyle
                )), (c.lineWidth = o), (c.strokeStyle = Si (
                  i.strokeStyle,
                  a
                )), c.setLineDash &&
                  c.setLineDash (Si (i.lineDash, r.borderDash)), n &&
                  n.usePointStyle)
              ) {
                ...
                c.fillRect (h.leftForLtr (t, m), e, m, p), 0 !== o &&
                  c.strokeRect (h.leftForLtr (t, m), e, m, p);
              c.restore ();
            }
          }) (
            w,
            k,
            e
          ), (v[i].left = h.leftForLtr (w, v[i].width)), (v[i].top = k), (function (t, e, n, i) {
    ...
    handleEvent: function (t) {
      ...
      (e = n._getLegendItemAt (t.x, t.y)), 'click' === a
        ...
        : (i.onLeave &&
            ...
            (n._hoveredItem &&
              i.onLeave.call (
                ...
                t.native,
                n._hoveredItem
              ), (n._hoveredItem = e)), i.onHover &&
            e &&
            i.onHover.call (n, t.native, e));
    },
  });
  function Ai (t, e) {
    ...
    fit: function () {
      ...
      n.display
        ? ((t =
            ...
            2 * n.padding), (e.width = i.width = a
            ? e.maxWidth
            : t), (e.height = i.height = a ? t : e.maxHeight))
    ...
    draw: function () {
      ...
      if (n.display) {
        ...
        (e.fillStyle = V.valueOrDefault (
          n.fontColor,
          z.global.defaultFontColor
        )), (e.font = o.string), t.isHorizontal ()
          ? ((a = h + (f - h) / 2), (r = d + l), (i = f - h))
          : ((a = 'left' === n.position ? h + l : f - l), (r =
              d + (c - d) / 2), (i = c - d), (u =
              Math.PI *
              ('left' === n.position ? -0.5 : 0.5))), e.save (), e.translate (
          a,
          r
        ), e.rotate (u), (e.textAlign = 'center'), (e.textBaseline = 'middle');
        var g = n.text;
        if (V.isArray (g))
  ...
  for (var Ni in ((Li.filler = Oi), (Li.legend = Ri), (Li.title = zi), (tn.helpers = V), (function () {
    ...
    (V.where = function (t, e) {
    ...
    }), (V.EPSILON = Number.EPSILON || 1e-14), (V.splineCurveMonotone = function (
      t
    ) {
      var e,
        n,
      ...
      for (e = 0; e < h; ++e)
        if (!(i = d[e]).model.skip) {
          if (
            ((n = e > 0 ? d[e - 1] : null), (a = e < h - 1 ? d[e + 1] : null) &&
              !a.model.skip)
          ) {
      ...
      for (e = 0; e < h - 1; ++e)
        (i = d[e]), (a = d[e + 1]), i.model.skip ||
          a.model.skip ||
          (V.almostEquals (i.deltaK, 0, this.EPSILON)
            ? (i.mK = a.mK = 0)
            : ((r = i.mK / i.deltaK), (o = a.mK / i.deltaK), (l =
                Math.pow (r, 2) + Math.pow (o, 2)) <= 9 ||
                ((s = 3 / Math.sqrt (l)), (i.mK = r * s * i.deltaK), (a.mK =
                  o * s * i.deltaK))));
      for (e = 0; e < h; ++e)
        (i = d[e]).model.skip ||
          ((n = e > 0 ? d[e - 1] : null), (a = e < h - 1
            ? d[e + 1]
            : null), n &&
            !n.model.skip &&
            ((u = (i.model.x - n.model.x) / 3), (i.model.controlPointPreviousX =
              i.model.x - u), (i.model.controlPointPreviousY =
              i.model.y - u * i.mK)), a &&
            !a.model.skip &&
            ((u = (a.model.x - i.model.x) / 3), (i.model.controlPointNextX =
              i.model.x + u), (i.model.controlPointNextY =
              i.model.y + u * i.mK)));
      ...
      return (
        (e
          ...
          : i <= 1 ? 1 : i <= 2 ? 2 : i <= 5 ? 5 : 10) * Math.pow (10, n)
      );
      ...
      if (1 !== n) {
        ...
        (i.height = a * n), (i.width = r * n), t.ctx.scale (n, n), i.style
          .height ||
          i.style.width ||
      ...
      i.font !== e &&
        ((a = i.data = {}), (r = i.garbageCollect = []), (i.font = e)), (t.font = e);
      ...
      var r = e[a];
      return r || ((r = e[a] = t.measureText (a).width), n.push (a)), r > i &&
        (i = r), i;
      ...
      ? function (t) {
          return t instanceof CanvasGradient && (t = z.global.defaultColor), k (
            t
          );
        }
      : function (t) {
  ...
  }) (), (tn._adapters = an), (tn.Animation = Z), (tn.animationService = $), (tn.controllers = $t), (tn.DatasetController = nt), (tn.defaults = z), (tn.Element = X), (tn.elements = _t), (tn.Interaction = ae), (tn.layouts = ge), (tn.platform = Fe), (tn.plugins = Le), (tn.Scale = xn), (tn.scaleService = Oe), (tn.Ticks = rn), (tn.Tooltip = Ue), tn.helpers.each (
    ci,
    function (t, e) {
  ...
  return 'undefined' != typeof window &&
    (window.Chart = tn), (tn.Chart = tn), (tn.Legend = Li.legend._element), (tn.Title = Li.title._element), (tn.pluginService = tn.plugins), (tn.PluginBase = tn.Element.extend ({})), (tn.canvasHelpers = tn.helpers.canvas), (tn.layoutService = tn.layouts), (tn.LinearScaleBase = Sn), tn.helpers.each (
